...
const cards = [
  {
    ...
    thumbnail: "../src/assets/images/commercial/com1.jpg",
  },
  {
    id: 2,
    content: <SkeletonTwo />,
    className: "col-span-1",
    thumbnail: "../src/assets/images/commercial/com2.jpg",
  },
  {
    id: 3,
    content: <SkeletonThree />,
    className: "col-span-1",
    thumbnail: "../src/assets/images/commercial/com3.jpg",
  },
  {
    id: 4,
    content: <SkeletonFour />,
    className: "col-span-1",
    thumbnail: "../src/assets/images/commercial/com4.jpg",
  },
  {
    id: 5,
    content: <SkeletonFive />,
    className: "col-span-1",
    thumbnail: "../src/assets/images/commercial/com5.jpg",
  },
];
